...
public class Java1
{
	public static void main(String args[])
	{
		 ...
		 AQAWriteTextFile writeToFile = new AQAWriteTextFile();
		 AQAConsole console = new AQAConsole();
		 AQAReadTextFile readFromFile = new AQAReadTextFile();
		 
		 String filename = "input.txt";
		 
		 int[] plaintext = new int[10];
		 
		 readFromFile.openTextFile(filename);
		 
		 String lineContents = readFromFile.readLine();
